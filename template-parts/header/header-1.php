<?php
    // header 1 top information 

    $email = get_theme_mod('harry_heading_email','info@educal.com');
    $number = get_theme_mod('harry_heading_numer','+964 742 44 763');
    $day =get_theme_mod('harry_heading_day', 'Sunday-Thures 10am-07pm');

    //switch here
    // $switch =get_theme_mod('harry_heading_email_switch', true);
                                        ...
                                        <span>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linejoin="round" />
                                                <path
                                                    d="M10.5969 10.226L8.42691 8.93101C8.04891 8.70701 7.74091 8.16801 7.74091 7.72701V4.85701"
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </span>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-2">
                        <div class="header__top-right d-flex justify-content-end align-items-center">
                            <div class="header__lang ml-30">
                                <span class="header__lang-selected-lang tp-lang-toggle"
